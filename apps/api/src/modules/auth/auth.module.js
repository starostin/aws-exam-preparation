...
var supabase_strategy_1 = require("./supabase.strategy");
var auth_guard_1 = require("./auth.guard");
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [passport_1.PassportModule.register({ defaultStrategy: 'jwt' })],
            providers: [supabase_strategy_1.SupabaseStrategy, auth_guard_1.AuthGuard],
            exports: [auth_guard_1.AuthGuard, passport_1.PassportModule],
        })];
