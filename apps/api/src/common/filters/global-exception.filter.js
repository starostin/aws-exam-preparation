...
var GlobalExceptionFilter = function () {
    ...
    var GlobalExceptionFilter = _classThis = /** @class */ (function () {
        ...
        GlobalExceptionFilter_1.prototype.catch = function (exception, host) {
            ...
            var correlationId = (0, crypto_1.randomUUID)();
            var status = exception instanceof common_1.HttpException
                ? exception.getStatus()
                : common_1.HttpStatus.INTERNAL_SERVER_ERROR;
            var message = exception instanceof common_1.HttpException
                ? (_a = exception.getResponse().message) !== null && _a !== void 0 ? _a : exception.message
                : 'Internal server error';
            this.logger.error({ correlationId: correlationId, status: status, message: message, exception: exception });
