    ...
    <main className='grid min-h-screen place-items-center px-4 py-8'>
      <Card className='w-full max-w-md border-border/70 bg-card/80'>
        <CardHeader>
          ...
          <CardDescription className='text-muted-foreground'>Start tracking your AWS study progress in minutes.</CardDescription>
        </CardHeader>
        ...
        <CardContent>
          ...
          <p className='mt-5 text-sm text-muted-foreground'>
            Already have an account? <Link className='text-cyan-600 hover:text-cyan-500 dark:text-cyan-300 dark:hover:text-cyan-200' href='/auth/sign-in'>Sign in</Link>
          </p>
        </CardContent>
      </Card>
    </main>
